...
export function Progress({ value = 0, max = 100, color = '#141ED2',
  ...
  return (
    <div className={className} style={{ display: 'flex', alignItems: 'center', gap: 10, ...style }} {...rest}>
      <div style={{
        flex: 1, height: h, borderRadius: h, background: '#EDF2F7', overflow: 'hidden',
      }}>
        <div style={{
      ...
      {showLabel && (
        <span style={{ fontSize: 12, fontWeight: 600, color: '#6E7191', minWidth: 36, textAlign: 'right',
