...
export function NotificationsOffStyleTwoTone({ size = 20, color = 'currentColor', className = '', style = {}, ...rest }) {
  const d = typeof window !== 'undefined' && window.iconData && window.iconData['NotificationsOffStyleTwoTone'];
